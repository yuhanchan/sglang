...
/// and the circuit breaker must NOT trip (transport was healthy; the verdict
/// is application-level, deliberately kept out of routing).
#[tokio::test]
...
/// chunk contributes one gap. End-to-end coverage that the chat handler
/// installs the ITL hook; the sse-level unit tests cover the pump primitive.
#[tokio::test]
